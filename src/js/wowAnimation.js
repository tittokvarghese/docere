function resizeWindow(sw)
{
if(sw > 1300)
{
$('.home').click(function(){ $("html, body").animate({ scrollTop: 440}, 300);return false; }); 
$('.about').click(function(){ $("html, body").animate({ scrollTop: 945}, 300);return false; }); 
$('.services').click(function(){ $("html, body").animate({ scrollTop: 1630}, 300);return false; }); 
$('.enquiry').click(function(){ $("html, body").animate({ scrollTop: 2350}, 300);$('#qname').focus();return false; }); 
$('.contact').click(function(){ $("html, body").animate({ scrollTop: 3030}, 300);return false; }); 
}
}
