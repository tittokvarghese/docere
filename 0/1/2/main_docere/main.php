...
// $mail->Host = 'smtp.gmail.com';
 ...
 $mail->SetFrom("auto-docere@gmail.com", "docere");
...
'December'  =>  '12'
    ...
    return $months[$month];
					...
					public static function CheckActiveUser($id)
					{
					$q	= dbTKV::SQLQUERY("SELECT * FROM users WHERE uid='".$id."' AND uact='1' ");
					if(dbTKV::SQLNUM_ROWS($q))
					return true;
					}
					
					public static function CheckActivePatient($id)
					{
					$q	= dbTKV::SQLQUERY("SELECT * FROM users WHERE uid='".$id."' AND uact='1' AND utype='Patient' ");
					if(dbTKV::SQLNUM_ROWS($q))
					return true;
					}
